...
- `handle_client` still performs one read into a fixed buffer. This is acceptable for the current phase. Phase 06A will add the minimal loop needed for partial requests; Phase 13 will add deliberate limits and connection behavior.
