...
- `handle_client` still performs one read into a fixed buffer. Phase 06A should replace that with minimal complete-request accumulation; Phase 13 should harden it with limits, timeouts, and explicit connection behavior.
